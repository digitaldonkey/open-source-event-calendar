...
timely.define("domReady", [], function () {
    ...
    var t = function () {
        var e = {zoom: 14, mapTypeId: google.maps.MapTypeId.ROADMAP},
            t = new google.maps.Map(document.getElementById("osec-gmap-canvas"), e),
            n = new google.maps.Marker({map: t}), r = new google.maps.Geocoder;
        r.geocode({address: document.getElementById("ai1ec-gmap-address").value}, function (e, r) {
    ...
    return {handle_show_map_when_clicking_on_placeholder: n, init_gmaps: t}
    ...
    var i = function () {
        ...
        e("#timely-description img[data-ai1ec-hidden]").each(function () {
            var t = e(this), n = e("#timely-event-poster img").attr("src");
            t.attr("src") != n && t.removeAttr("data-ai1ec-hidden")
        })
    }, u = function () {
        t(function () {
            i(), s(), o(), e(document).trigger("event_page_ready.ai1ec"), e("body").addClass("ai1ec-event-details-ready")
        })
    };
    return {start: u}
