...
class AdminPageWidgetCreator extends AdminPageAbstract
{
    ...
    public function display_meta_box($object, $box)
    {
        ...
        $args = [
            ...
            'text_common_info'  => I18n::__('Use this tool to generate code snippets you can add to <strong>an external website</strong> to embed new calendars and widgets.'),
            'text_alert'        => I18n::__('<h4>Attention!</h4><p>These widgets are designed to be embedded in <strong>external sites only</strong> and may cause conflicts if used within the same WordPress site.</p>'),
            'text_alternatives' => sprintf(
                I18n::__('<p>Use <a href="%s"><strong>X3P0 - Legacy Widget</a></strong> to add event widgets to your WordPress, or use shortcodes to embed the full calendar.</strong></p>'),
            ...
            'text_updated_code' => I18n::__('This code will update to reflect changes made to the settings. Changing settings will not affect previously embedded widgets.'),
        ];
