...
class EventSingleView extends OsecBaseClass
{
    ...
    public function get_content(Event $event)
    {
        ...
        $args = [
            ...
            'text_add_calendar'      => __('Add to Calendar', OSEC_TXT_DOM),
            ...
            'text_cost'              => __('Cost:', OSEC_TXT_DOM),
            'text_contact'           => __('Contact:', OSEC_TXT_DOM),
            'text_free'              => __('Free', OSEC_TXT_DOM),
            'text_repeats'           => __('Repeats', OSEC_TXT_DOM),
            'text_xcludes'           => __('Excludes', OSEC_TXT_DOM),
