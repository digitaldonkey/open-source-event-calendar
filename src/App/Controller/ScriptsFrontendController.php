...
class ScriptsFrontendController extends OsecBaseClass
{
    ...
    public function __construct(App $app)
    {
        ...
        $this->_settings = $this->app->settings;
        $this->_aco = new AccessControl();
    }
    ...
    public function render_js()
    {
        ...
        $translation[ 'calendar_url' ] = $this->_settings->get('calendar_page_id') ? get_permalink($this->_settings->get('calendar_page_id')) : '';

        // TODO
        //  If settings arn't initialized, No Page set we will fail here.

        $translation[ 'full_calendar_url' ] = $this->_settings->get('calendar_page_id') ? get_page_link($this->_settings->get('calendar_page_id')) : '';
...
JSC;
    ...
    public function get_frontend_translation_data()
    {
        ...
        $data[ 'fonts' ][] = ['name' => 'League Gothic', 'url' => $fonts_dir.'font-league-gothic.css'];
        $data[ 'fonts' ][] = ['name' => 'fontawesome', 'url' => $fonts_dir.'font-awesome.css'];
    ...
    public function get_translation_data()
    {
        ...
        $data = [
            ...
            'show_at_least_six_hours'        => __('For week and day view, you must select an interval of at least 6 hours.', OSEC_TXT_DOM),
        ];
    ...
    {
        $conditional_get = new HTTP_ConditionalGet(['contentHash' => md5($javascript)]
        );
    ...
    private function _are_we_editing_event_categories()
    {
        ...
        return (
            in_array($path_details[ 'basename' ], [
                'edit-tags.php',
                'term.php',
            ])
            && $post_type === OSEC_POST_TYPE
