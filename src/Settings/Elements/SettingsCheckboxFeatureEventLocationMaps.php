 ...
 */
class SettingsCheckboxFeatureEventLocationMaps extends SettingsAbstract
{
    public function render($html = '', $wrap = true): string
    {
        ...
        if (
            !(
                $this->app->settings->get('feature_event_location')
                && $this->app->settings->get('feature_event_location_maps')
        )) {
